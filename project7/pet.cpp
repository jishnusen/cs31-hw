...
void Pet::eat(int amt) { m_health += amt; }

void Pet::play() { m_health--; }

string Pet::name() const { return m_name; }

int Pet::health() const { return m_health; }

bool Pet::alive() const { return m_health > 0; }
